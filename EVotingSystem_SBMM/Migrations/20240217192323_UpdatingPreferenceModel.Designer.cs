...
namespace EVotingSystem_SBMM.Migrations
{
    ...
    [Migration("20240217192323_UpdatingPreferenceModel")]
    partial class UpdatingPreferenceModel
    {
            ...
            modelBuilder.Entity("EVotingSystem_SBMM.Models.VotePreferenceModel", b =>
                {
                    ...
                    b.HasOne("EVotingSystem_SBMM.Models.EventModel", "GetEvent")
                        .WithMany()
                        .HasForeignKey("EventId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

...
public class VotePV_Tests
{
    ...
    [Fact]
        public void SubmitVotePV_Returns_SuccessfulVoteSubmission()
        {
        ...
        [Fact]
        public void SubmitVotePV_Returns_Error_When_RankOrCandidateIdIsNotProvided()
        {
            // Arrange
            var httpContext = new DefaultHttpContext();
            var voter = GetSampleVoter();
        ...
        [Fact]
        public void SubmitVotePV_ShouldHandle_ErrorSubmittingVote()
        {
            // Arrange
            var httpContext = new DefaultHttpContext();
            var voter = GetSampleVoter();
    ...
    [Fact]
    public void VotesResultPV_Returns_Error_When_NoVotes()
    {
        // Arrange
        var httpContext = new DefaultHttpContext();
        var eventModel = GetSampleEvent();
